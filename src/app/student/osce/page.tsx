  ...
  return (
    <>
      ...
      <section className="hero-desk osce-hero">
        <div><p className="eyebrow">8 分钟 · 100 分 · 一次作答</p><h1>准备好后，再推开考站的门</h1>
        ...
        <div className="osce-ticket" aria-label="考站信息"><span>STATION 01</span><strong>08:00</strong><small>儿童呼吸系统</small></div>
      </section>
